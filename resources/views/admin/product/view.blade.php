                    ...
                    <form name="form" id="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <select name="category" id="category" class="form-control category_dd" data-placeholder="Select Category" disabled>
                            ...
                            <div class="form-group col-sm-12" id="variant-template-{{ $key+1 }}">
                                <div class="row">
                                    <div class="form-group col-sm-10">
                                        ...
                                        <input type="text" class="form-control" id="variant" name="variant[]" placeholder="Please enter variant" value="{{ $product_variant }}" disabled>
...
<!-- Page JS -->
<script src="{{ asset('backend/project/product/view.js') }}"></script>
